...
SECRET_KEY = env.get_value('SECRET_KEY', default='django-insecure-9rbviz-jip=v_d%w+g2wmjic)a%ss1=g1xz(*4s8x((yod6^pl')
...
WSGI_APPLICATION = 'cosmo_apis.wsgi.application'
